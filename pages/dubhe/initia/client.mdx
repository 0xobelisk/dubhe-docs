...
Dubhe is a client-agnostic SDK that supports various platforms including browsers, Node.js, and the COCOS game engine. It provides a simple interface to interact with your initia Move contracts.
...
```typescript
import { Transaction } from "@0xobelisk/initia-client";
...
1. The current implementation cannot automatically decode enum types due to limitations in initia metadata.
