...
```move move sui move filename="counter_system.move" {8} copy showLineNumbers
module counter::counter_system {
    use counter::counter_schema::Counter;
    use counter::counter_event_increment;
    use counter::counter_error_invalid_increment;
...
```move move sui move filename="counter_system.move" {11-14} copy showLineNumbers
module counter::counter_system {
    use counter::counter_schema::Counter;
    use counter::counter_event_increment;
...
```move move sui move filename="scripts/migrate.move" {11-16} copy showLineNumbers
