...
```move move filename="deploy_hook.move" {3-4, 7-28} copy showLineNumbers
...
```move move filename="deploy_hook.move" {5, 31-41} copy showLineNumbers
module monster_hunter::deploy_hook;
use monster_hunter::schema::Schema;
use monster_hunter::terrain_type;
use monster_hunter::map_config;
...
```move move filename="map_system.move" {5, 10-11, 33-34} copy showLineNumbers
...
```move move filename="map_system.move" {11-14, 40-43} copy showLineNumbers
module monster_hunter::map_system;
use monster_hunter::schema::Schema;
use monster_hunter::position;
use monster_hunter::errors::already_registered_error;
