...
```move move filename="deploy_hook.move" {39-41} copy showLineNumbers
...
```move move filename="map_system.move" {22} copy showLineNumbers
...
```move move filename="map_system.move" {27, 51-57} copy showLineNumbers
module monster_hunter::map_system;
use monster_hunter::schema::Schema;
use monster_hunter::position;
use monster_hunter::errors::already_registered_error;
...
```move move filename="map_system.move" {30} copy showLineNumbers
module monster_hunter::map_system;
use monster_hunter::schema::Schema;
use monster_hunter::position;
use monster_hunter::errors::already_registered_error;
...
```move move filename="map_system.move" {56, 61-74} copy showLineNumbers
module monster_hunter::map_system;
use monster_hunter::schema::Schema;
use monster_hunter::position;
use monster_hunter::errors::already_registered_error;
...
```move move filename="encounter_system.move" copy showLineNumbers
...
```move move filename="encounter_system.move" {37-44} copy showLineNumbers
module monster_hunter::encounter_system;
use monster_hunter::schema::Schema;
use monster_hunter::monster_catch_result;
use monster_hunter::events::monster_catch_attempt_event;
