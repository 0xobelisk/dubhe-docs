...
```bash
 pnpm dubhe query --network localnet --schema message --field content
[ 'Hello, World!' ]
```
...
➜   pnpm dubhe call --network localnet --module message_system --function send --params "object:0x9665693bc66ba63b7fc92a83631d4f9157bd79a767084e7799663086c0c179f7" "string:Sui Move"
{
