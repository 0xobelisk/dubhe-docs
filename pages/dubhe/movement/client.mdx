...
Dubhe is a client-agnostic SDK that supports various platforms including browsers, Node.js, and the COCOS game engine. It provides a simple interface to interact with your movement Move contracts.
...
```typescript
import { loadMetadata, Dubhe, NetworkType } from "@0xobelisk/movement-client";
...
```typescript
import { Transaction } from "@0xobelisk/movement-client";
...
1. The current implementation cannot automatically decode enum types due to limitations in movement metadata.
