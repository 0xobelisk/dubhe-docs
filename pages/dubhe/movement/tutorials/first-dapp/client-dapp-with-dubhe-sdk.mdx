...
import {
  ...
  DevInspectResults,
  NetworkType,
} from "@0xobelisk/movement-client";
...
function getExplorerUrl(network: NetworkType, digest: string) {
  switch (network) {
    ...
    case "mainnet":
      return `https://movementscan.xyz/tx/${digest}`;
    case "devnet":
      return `https://explorer.polymedia.app/txblock/${digest}?network=${network}`;
    case "localnet":
    ...
    <div className="max-w-7xl mx-auto text-center py-12 px-4 sm:px-6 lg:py-16 lg:px-8 flex-6">
      <div className="flex flex-col gap-6 mt-12">
        <div className="flex flex-col gap-4">
          You account already have some movement from {NETWORK}
...
like this:
![101-front-end](/movement/101-front-end.png)
