...
About Testing and Debugging,Dubhe Using Native movement Move Way to slove this process.

https://docs.movement.io/guides/developer/first-app/build-test#testing-a-package
https://docs.movement.io/guides/developer/first-app/debug
