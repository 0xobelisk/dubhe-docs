...
```typescript
import { Transaction } from "@0xobelisk/aptos-client";
...
1. The current implementation cannot automatically decode enum types due to limitations in aptos metadata.
